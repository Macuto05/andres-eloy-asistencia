...
export default function DocentesClient({ personalData, diasHabiles, registros }: DocentesClientProps) {
    ...
    const handleBlur = async (nivel: string) => {
        ...
        // Save to DB (No Year)
        await saveAsistenciaMensual(selectedMonth, "Docente", nivel, valor)
    }
    ...
    return (
        <div className="w-full relative">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Docentes</h1>
                            ...
                            {personalData.length === 0 ? (
                                <tr>
                                    <td colSpan={10} className="py-8 text-center text-gray-500 italic">
                                        No hay personal registrado como "Docente".
                                    </td>
                                </tr>
                            ) : (
            ...
            <div className="flex justify-end mt-6">
                <button
                    onClick={() => {
                        const reportTitle = "REPORTE DE ASISTENCIA - DOCENTES"
                        const period = selectedMonth.toUpperCase()
                        const filename = `asistencia_docentes_${selectedMonth.toLowerCase()}_${new Date().getFullYear()}.csv`
