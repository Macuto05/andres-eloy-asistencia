...
export default function ObrerosClient({ personalData, diasHabiles, registros }: ObrerosClientProps) {
    ...
    const handleBlur = async (nivel: string) => {
        ...
        // Save to DB (No Year)
        await saveAsistenciaMensual(selectedMonth, "Obrero", nivel, valor)
    }
    ...
    return (
        <div className="w-full relative">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Obreros</h1>
                            ...
                            {personalData.length === 0 ? (
                                <tr>
                                    <td colSpan={10} className="py-8 text-center text-gray-500 italic">
                                        No hay personal registrado como "Obrero".
                                    </td>
                                </tr>
                            ) : (
            ...
            <div className="flex justify-end mt-6">
                <button
                    onClick={() => {
                        const reportTitle = "REPORTE DE ASISTENCIA - OBREROS"
                        const period = selectedMonth.toUpperCase()
                        const filename = `asistencia_obreros_${selectedMonth.toLowerCase()}_${new Date().getFullYear()}.csv`
