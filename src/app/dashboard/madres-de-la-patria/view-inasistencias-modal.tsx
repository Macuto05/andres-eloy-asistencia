...
export default function ViewInasistenciasModal({ isOpen, onClose, nivel, mes, cargo }: ViewInasistenciasModalProps) {
    ...
    }, [isOpen, nivel, mes, cargo])

    const loadData = async () => {
        setLoading(true)
        const res = await getInasistencias(mes, cargo, nivel)
