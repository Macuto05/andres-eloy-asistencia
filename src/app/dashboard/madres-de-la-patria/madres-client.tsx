...
export default function MadresClient({ personalData, diasHabiles, registros }: MadresClientProps) {
    ...
    // Map key: "nivel" -> value: asistencia input
    ...
    const handleBlur = async (nivel: string) => {
        ...
        // Save to DB (No Year)
        await saveAsistenciaMensual(selectedMonth, "Madre de la patria", nivel, valor)
    }
    ...
    return (
        <div className="w-full relative">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Madres de la Patria</h1>
                            ...
                            {personalData.length === 0 ? (
                                <tr>
                                    <td colSpan={10} className="py-8 text-center text-gray-500 italic">
                                        No hay personal registrado como "Madre de la patria".
                                    </td>
                                </tr>
                            ) : (
                                        ...
                                        <tr key={item.id} className="hover:bg-gray-50 transition-colors group">
                                            ...
                                            <td className="py-4 text-center align-middle">
                                                <div className="relative flex justify-center items-center gap-1 mx-auto h-full">
                                                    {/* Added 'relative' and removed 'flex-col' to keep input centered */}
                                                    <input
                                                        type="number"
            ...
            <div className="flex justify-end mt-6">
                <button
                    onClick={() => {
                        const reportTitle = "REPORTE DE ASISTENCIA - MADRES DE LA PATRIA"
                        const period = selectedMonth.toUpperCase()
                        const filename = `asistencia_madres_${selectedMonth.toLowerCase()}_${new Date().getFullYear()}.csv`
