            ...
            <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
                ...
                <form action={handleSubmit} className="space-y-4">
                    ...
                    <button
                        ...
                        className={`w-full py-2 text-sm font-medium text-white rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 
